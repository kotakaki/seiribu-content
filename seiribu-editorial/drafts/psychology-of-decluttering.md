...
> - **ChatGPT用プロンプト（DALL-E 3 推奨）**：
>   画像を1枚だけ生成してください。: Flat editorial illustration. Scene: A 30-40s Japanese woman shown in profile, looking troubled, surrounded by piles of cardboard boxes and garbage bags, with a thought bubble or glowing vision of a clean, bright, empty room. Style: warm, clean vector art. IMPORTANT: Must have a pure white or very simple solid background for easy cutout. Draw ONLY the character and the objects around her. Do NOT generate the title or any text. Tone: empathetic and hopeful. No logos. Aspect ratio 16:9.
