...
| 3 | 記事内図解 | 画像生成でサンプルのようなイラスト図解ベースを作り、Pillow、SVG、またはCanvaで短いラベルとロゴを正確に合成する | 1200 x 675 | 16:9 | `siblings-share-inline-options.png` | 本文中のCMSブリーフ位置 |
...
- WordPress画像タイトル: 片付けの負担を「作業・費用・手配」に分ける図解
