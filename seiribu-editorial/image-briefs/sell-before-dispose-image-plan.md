...
- 記事ファイル: `seiribu-editorial/drafts/sell-before-dispose.md`
- スラッグ: `sell-before-dispose`
...
- 生成候補の一時置き場: `/private/tmp/seiribu-image-work/sell-before-dispose`
- 採用画像の公開用置き場: `seiribu-editorial/assets/images/sell-before-dispose`
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | アイキャッチ素材 | 画像生成素材 + 背景透過（ローカル合成で仕上げ） | 1200 x 675 | 16:9 | `sell-before-dispose-eyecatch.png` | アイキャッチ合成用素材 |
| 2 | 記事内イメージ | 画像生成素材 | 1200 x 675 | 16:9 | `sell-before-dispose-inline-01.png` | 本文中のCMSブリーフ位置 |

## 保留した画像

| 用途 | ファイル名 | 保留理由 |
| --- | --- | --- |
| 記事内イメージ | `sell-before-dispose-inline-male-memory.png` | lightモードでは本文画像を1件までに絞ります。必要なら --mode standard で出力します。 |

## 制作ブリーフ

### 1. アイキャッチ素材

- ファイル名: `sell-before-dispose-eyecatch.png`
...
- サブタイトル: 損しない処分の順番
- 出力サイズ: 1200 x 675
- 出力ファイル: `sell-before-dispose-eyecatch-branded.png`
- ロゴ: `seiribu-editorial/assets/images/brand/seiribu-logo.png`
- ロゴ必須: はい
- ロゴ位置: 左上
...
- ファイル名: `sell-before-dispose-inline-01.png`
...
- imagegenの生成候補は `/private/tmp/seiribu-image-work/sell-before-dispose` に置き、採用画像だけ `seiribu-editorial/assets/images/sell-before-dispose` に移す。
- 公開用フォルダに残った候補や旧版は `seiribu-editorial/scripts/clean_image_assets.py --article sell-before-dispose --dry-run` で確認してから退避する。
